...
var dialogPolyfillURL = "https://esm.run/dialog-polyfill";
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Promise.resolve("".concat(dialogPolyfillURL)).then(function (s) {
                return _interopRequireWildcard(require(s));
              });

            case 2:
              _yield$import = _context.sent;
              polyfill = _yield$import["default"];
