...
var BoltPopup = /*#__PURE__*/function () {
  ...
  _createClass(BoltPopup, [{
    ...
    value: function initPopup() {
      ...
      var btns = document.querySelectorAll("[data-target-popup=\"".concat(this.popup.getAttribute('data-path-popup'), "\"]"));

      // в цикле отслеживаем по ним клик и открываем окно
      var _loop = function _loop(i) {
        btns[i].addEventListener('click', function () {
          _this2.isOpen(btns[i]);
        });
      };
    ...
    value: function isOpen(clickBtn) {
      ...
      document.body.style.top = "-".concat(this.scrollHeight, "px");
